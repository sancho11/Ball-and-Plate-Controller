...
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)0x48000298u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480002BCu)
...
uint8 CYXDATA * const CYCODE Touch_ADC_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Touch_ADC_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: Touch_ADC_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Touch_ADC_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*Touch_ADC_AMux__addrTable[channel] |= Touch_ADC_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: Touch_ADC_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Touch_ADC_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*Touch_ADC_AMux__addrTable[channel] &= (uint8)~Touch_ADC_AMux__maskTable[channel];
	}
}

int8 Touch_AMux_curChannel = -1;

void Touch_AMux_DisconnectAll(void)
{
	Touch_AMux_curChannel = -1;
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P6_U1_CFG24), 0x44044444u);
